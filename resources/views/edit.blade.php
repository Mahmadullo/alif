...
<div id="form-edit-contact">
    ...
    @if (sizeof($contact->phones) > 0):
        ...
        <div class="input-group mb-3" id="phone-number-{{ $phone->id }}">
            <div class="input-group-prepend">
                <span class="input-group-text">Phone:</span>
            </div>
            <input type="text" class="form-control" placeholder="Phone" aria-label="Phone" value="{{ $phone->content }}">
    ...
    @if (sizeof($contact->emails) > 0):
        ...
        <div class="input-group mb-3" id="email-address-{{ $email->id }}">
            <div class="input-group-prepend">
                <span class="input-group-text">Email:</span>
            </div>
            <input type="text" class="form-control" placeholder="Email" aria-label="Email" value="{{ $email->content }}">
